...
open class TypeToken<T> protected constructor() {
    ...
    private class GenericArrayTypeImpl(componentType: Type) : GenericArrayType, java.io.Serializable {
    ...
    private class WildcardTypeImpl(upperBounds: Array<Type>, lowerBounds: Array<Type>) : WildcardType, java.io.Serializable {
